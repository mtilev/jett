    ...
    protected void check(Workbook workbook)
    {
        ...
        for (int i = 0; i < 58; i++)
        {
            ...
            if (population >= 1000000)
                assertTrue("Expected bold font at row " + (i + 2) + ", cell 1",
                        popFont.getBold());
            else
                assertFalse("Expected not bold font at row " + (i + 2) + ", cell 1",
                        popFont.getBold());
        ...
        for (int i = 0; i < 17; i++)
        {
            ...
            if (population >= 1000000)
                assertTrue("Expected bold font at row " + (i + 2) + ", cell 7",
                        popFont.getBold());
            else
                assertFalse("Expected not bold font at row " + (i + 2) + ", cell 7",
                        popFont.getBold());
